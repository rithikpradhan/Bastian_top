    ...
    <div className="popup_overlay" ref={overlayRef}>
      ...
      <div className="form_title">
        ...
        <form className="popup_form">
          ...
          <button type="submit" className="submit_btn">Confirm Booking</button>
        </form>
        ...
        <div className="terms">
            <h1>Restaurant Terms & Conditions</h1>
             <li><b>Dress Code:</b> Smart Casual. Men, please note regrettably no open sandals/shoes. Shorts may be worn on the occasion of Brunch.</li>
            <li><b>Details:</b> Deposit/Cover Charge is not required for the children below 15 years of age.</li>
        </div>
