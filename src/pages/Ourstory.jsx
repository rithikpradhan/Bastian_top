...
import img1 from "../assets/bastian_name.webp";
import img2 from "../assets/bastian_2010.webp";
import img4 from "../assets/bastian-top-2.webp";
import img5 from "../assets/bastian--garden.webp";
    ...
    <div className="ourstory" ref={containerRef}>
        ...
        <div className="story_container">
          <div className="story_text">
            <p>
              ...
              in Pune. Further, Bastian also launched its second Bastian Mumbai
              outlet - At The Top, which is an iconic & unmissable rooftop
              location in the middle of Mumbai, on the 48th floor, with a
              restaurant, lounge, club and pool, which has quickly become the
              most coveted dining and nightlife spot in the city. Future
              projects include Inka by Bastian and a casual coffee concept -
              Blondie.
            </p>

            <p>
              Exquisite elegance and culinary mastery define us. Each chapter of
              our journey showcases extraordinary dining experiences that
              elevate luxury.
            </p>
          </div>
        ...
        <div className="visionaries">
          <div className="vision_card">
            ...
            <div className="card_info">
              <p>
                Bastian Hospitality (formerly Aalia Hospitality) was established
                by Ranjit Bindra in 2014, and has several strong brands (past
                and present) under its banner, including A Bar Called Life,
                Arth, One Street, Binge and its iconic Bastian brand. With
                Ranjit's vision, the brand has expanded pan-India to Bangalore &
                Pune with upcoming projects in Goa, among other Indian metros.
                Additionally, Ranjit is focusing on new culinary concepts,
                including a Peruvian Asian luxury dining experience - Inka.
              </p>
            </div>
          </div>
      ...
      <div className="timeline_card">
        ...
        <div className="year_section">
          <img
            ref={leftImgRef}
            src={data[index].leftImg}
            className="float_img left"
          />
          <h1 ref={yearRef} className="big_year">
            {data[index].year}
          </h1>
          <img
            ref={rightImgRef}
            src={data[index].rightImg}
            className="float_img right"
          />
        </div>
